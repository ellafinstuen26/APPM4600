...
def driver():
   ...
   # f3 = lambda x: 12/(1+x)
    ...
    #Exercise 2
    x0 = 3**(1/3)
    [y,xstar,ier] = fixed_pt(f3,x0,tol,Nmax)
    print('the approximate fixed point is:',xstar)
    print('approximations: ', y, len(y))
    print('f1(xstar):',f3(xstar))
    print('Error message reads:',ier)
    [fit,diff1,diff2] = convergence_order(y,xstar)
