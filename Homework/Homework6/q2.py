...
def driver():
    ...
    elapsed = time.time()-t
    print("(i) Newton")
    print("Newton: the solution is: ",xstar)
    ...
    # [xstar,gval,ier,its] = SteepestDescent(x0,tol,Nmax)
    # print("(ii) Steppest Descent")
    # print("Steppest Descent: the solution is: ",xstar)
    # print("Steppest Descent: g evaluated at this point is ", gval)
    # print("Steppest Descent: the error message reads: ", ier, '\n'	)

    # [xstar,ier,its] = special(x0,tol,Nmax)
    # print("(iii) Hybrid")
    # print("Hybrid: The solution is: :",xstar)
...
def special(x,tol,Nmax):
    [xstar,gval,ier, its] = SteepestDescent(x,5e-2,Nmax)
    if ier == 0:
        l = []
        l = Newton(xstar,tol,Nmax)
        l[2] += its
        return l
    if ier == 1:
        return [xstar,gval,ier,]
